package ru.mirea.panin.audiorecord;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button startRecordBtn, stopRecordBtn, pauseBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isWork = hasPermission(this, PERMISSIONS);
        if (!isWork) {
    ...
    public void onPauseRecord(View v) {
        if (playing) {
            pauseRecording();
        } else {
            resumeRecording();
    ...
    private void resumeRecording() {
        try {
            if (mediaRecorder != null) {
                ...
                pauseBtn.setText("Pause rec");
                playing = true;
            }
        } catch (IllegalStateException e) {
            Log.d(TAG, "Not playing right now!");
        }
    }
